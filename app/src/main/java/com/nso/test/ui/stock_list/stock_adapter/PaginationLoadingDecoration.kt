...
class PaginationLoadingDecoration : RecyclerView.ItemDecoration() {
    ...
    private var isLastItemListener: IsLastItemListener? = null
    private var isEnabled = true

    interface IsLastItemListener {
        fun isLastItem()
    }
    ...
    fun setIsLastItemListener(isLastItemListener: IsLastItemListener) {
        this.isLastItemListener = isLastItemListener
    }
